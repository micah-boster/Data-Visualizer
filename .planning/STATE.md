...
status: unknown
last_updated: "2026-04-19T02:55:14.598Z"
progress:
  total_phases: 36
  completed_phases: 33
  total_plans: 92
...
- [v4.5 Hardening seed] Fix summary row aggregation and formatter binding — partner-table footer applies blanket sum across all numeric columns ignoring column semantics. One bug, five symptoms on Affirm partner page (Lender ID sums, batch-age sums nonsensically, Total Accounts renders as currency, Total Placed renders tiny, Avg Place NaN). Fix shape: per-column aggregation strategy (sum/avgWeighted/none/range) on column definitions + footer reuses column's formatter. Do NOT fix until phase 37 ships and v4.5 kicks off — seed example for Phase 39 (Data Correctness) and Phase 41 (Behavioral QA). File: `.planning/todos/pending/2026-04-19-fix-summary-row-aggregation-and-formatter-binding.md`
